    ...
    <div className="collect-panel">
      {!collectionActive && (
        <div className="idle-card card">
          <h2>Ready to collect training data</h2>
          <p className="muted">
            Turn on your webcam and start collection when you are ready. Nothing records until
      ...
      <div className="phase-banner">
        ...
        <p className="phase-message">
          {!collectionActive
            ? "Collection is idle — start when you are ready"
            : engine?.paused
              ? "Collection paused — press Resume to continue"
              : engine?.message || "Collecting…"}
        </p>
        ...
        <div className="video-card">
          ...
          {!cameraEnabled ? (
            <div className="video-placeholder camera-error">
              Camera off — start collection to enable the webcam
            </div>
          ) : cameraOk ? (
            <img
              className="live-feed"
